 ...
 * https://threejs.org/
 *
 * 3D model courtesy of jeff1234678@Sketchfab
 ...
 * The 3d model is impoted using the GLTFLoader module and is rendered using 3 lights
 * and a perspective camera. The model is then pun on an animation loop, gently rotating it around
 * the X an Y axis. Camera controls are achieved with mouse interactions the OrbitControls module.
 */
